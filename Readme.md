...
![Language](https://img.shields.io/static/v1?label=language&message=english%20%7C%20french%20%7C%20german%20%7C%20italian%20%7C%20polish%20%7C%20spanish%20%7C%20russian%20%7C%20&color=informational)

**Autor** : **Raven**, **Magnus Thorenson** and **CoM Solaufein**

[Link to original Mod Download](https://github.com/The-Gate-Project/Com_encounters/releases/tag/v1.10)
...
Double-click the com_encounters.exe file and install to your main BG2 directory
...
Uninstalling is simple. Double-click the setup-com_encounters.exe file and enter the given commands for Uninstallation.
Afterwards, you may delete the following files:

    com_encounters.exe
    com_encounters.tp2
    com_encounters.debug
...
- Version 1.20 Review (october 20, 2023)  
    ...
    Add GAME_IS eet.  
	Update readme.html, Add Readme.md  
	...
	Remove unimplemented items from UCMGST02.STO.  
...
- Version 1.07 (August 19, 2012)  
    ...
    Added Shout scripts to the Chang encounter.  
...
- Version 1.01 (June 6, 2005)  
    ...
    Added Improved Druids Encounter  
...
- Version 1.00 Full release. (April 18, 2005)  
    ...
    Update the Weidu installer to version 176.  
...
- Version 2.00 BETA release. (January 19, 2005)  
    ...
    Update the Weidu installer to version 169.  
